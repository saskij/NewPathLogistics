            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
                    ...
                    <div className="flex flex-col items-start p-8 md:p-12 border-b md:border-b-0 md:border-r border-zinc-800 bg-zinc-900/20 hover:bg-zinc-900/40 transition-colors duration-500">
                        ...
                        <h3 className="text-2xl font-bold text-white uppercase tracking-tighter mb-4">Performance First</h3>
                        <p className="text-zinc-400 leading-relaxed min-h-[4rem]">
                            We value performance over labels. Your results today define your success, not your background.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start p-8 md:p-12 border-b md:border-b-0 md:border-r border-zinc-800 bg-zinc-900/20 hover:bg-zinc-900/40 transition-colors duration-500">
                        ...
                        <p className="text-zinc-400 leading-relaxed min-h-[4rem]">
                            Integrity in every mile — from transparent calculations to open communication.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start p-8 md:p-12 bg-zinc-900/20 hover:bg-zinc-900/40 transition-colors duration-500">
                        ...
                        <h3 className="text-2xl font-bold text-white uppercase tracking-tighter mb-4">Industrial Reliability</h3>
                        <p className="text-zinc-400 leading-relaxed min-h-[4rem]">
                            Guaranteed routes and technical excellence. Consistent miles you can rely on.
                        </p>
                    </div>
