...
export default function Footer() {
        ...
        <footer className="bg-black text-white pt-20 pb-10 border-t border-white/10">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    ...
                    {/* Contact Info */}
                    <div>
                        <h3 className="text-2xl font-bold uppercase tracking-tight mb-8">Contact Us</h3>
                        <ul className="space-y-6">
                            <li className="flex items-start gap-4 group">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold hover:text-gray-300 transition-colors">
                            ...
                            <li className="flex items-start gap-4 group">
                                ...
                                <div>
                                    <p className="text-sm text-gray-400 uppercase tracking-wider mb-1">Headquarters</p>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <h3 className="text-2xl font-bold uppercase tracking-tight mb-8">Connect</h3>
                        <div className="flex gap-6 mb-10">
                            <a href="#" className="p-3 bg-white/10 rounded-full hover:bg-white hover:text-black transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <nav>
                            <ul className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-sm font-bold uppercase tracking-widest text-gray-500">
                    ...
                    <div className="flex flex-col items-end">
                        <h3 className="text-2xl font-bold uppercase tracking-tight mb-8 text-right w-full">Nationwide Coverage</h3>
                        <div className="relative w-full max-w-sm aspect-[5/3] opacity-60 hover:opacity-100 transition-opacity duration-500">
                            {/* Simplified Stylized US Map SVG */}
                            <svg viewBox="0 0 950 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full stroke-white/50 stroke-1 hover:stroke-white transition-colors duration-500">
	...
	c10.6-5.1,17.3-15.9,17.3-27.7c0-2.4-0.3-4.7-0.8-7.1c-2.6-10.9,2.9-22,13.2-26.2C921.2,138.8,934.3,134.9,936.8,127.3z"/>
                        ...
                        <p className="text-sm text-gray-500 mt-4 uppercase tracking-widest">Serving all 48 contiguous states</p>
                    </div>
                </div>

                <div className="border-t border-white/10 pt-8 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 uppercase tracking-widest">
