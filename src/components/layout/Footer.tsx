...
export default function Footer() {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20 mb-20 items-stretch">
                    ...
                    <div className="flex flex-col items-start md:items-end h-full">
                        ...
                        <div className="relative w-full aspect-[5/3] group">
                            {/* Stylized US Map SVG - Lighter strokes and pulsating marker */}
                            <svg viewBox="0 0 950 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full stroke-zinc-400 stroke-[1.5] group-hover:stroke-white transition-colors duration-500">
    ...
    c10.6-5.1,17.3-15.9,17.3-27.7c0-2.4-0.3-4.7-0.8-7.1c-2.6-10.9,2.9-22,13.2-26.2C921.2,138.8,934.3,134.9,936.8,127.3z"/>
                                ...
                                {/* Pulsating Marker for Colorado Area */}
                                <circle cx="340" cy="280" r="3" className="fill-red-600 animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite]" />
                                <circle cx="340" cy="280" r="3" className="fill-red-600" />
                            </svg>
                        </div>
